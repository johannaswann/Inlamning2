...
Jag designade min databasen med hjälp av MySQL och valde att dela upp den i separata tabeller för kunder, böcker, beställningar och orderrader för att göra strukturen tydligare och för att undvika duplicerad data. Med hjälp av primärnycklar (PK) och främmande nycklar (FK) kopplas tabellerna kopplas ihop så att datan hör ihop. 
